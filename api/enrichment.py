...
def enrich_articles_with_events_and_trends(articles):
    ...
    article_event_map, article_link_to_trends, feed_title_map, feed_favicon_map = _build_mappings(events, trends, feeds)
    
    _apply_enrichment(articles, article_event_map, article_link_to_trends, feed_title_map, feed_favicon_map)
...
def _apply_enrichment(articles, article_event_map, article_link_to_trends, feed_title_map, feed_favicon_map):
